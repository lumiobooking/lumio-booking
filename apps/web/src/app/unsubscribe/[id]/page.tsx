...
export default function UnsubscribePage() {
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: 'var(--cf1f5f9)', padding: 20,
      ...
      <div style={{ width: '100%', maxWidth: 480, background: '#fff', borderRadius: 16, padding: '36px 32px',
        ...
        {state === 'working' && <p style={{ color: 'var(--c64748b)', margin: 0 }}>Working…</p>}
        ...
        {state === 'done' && (
          <>
            ...
            <h1 style={{ fontSize: 22, margin: '0 0 10px', color: 'var(--c0f172a)' }}>You&rsquo;re unsubscribed</h1>
            <p style={{ color: 'var(--c475569)', fontSize: 15, lineHeight: 1.6, margin: 0 }}>
        ...
        {state === 'error' && (
          <>
            <h1 style={{ fontSize: 20, margin: '0 0 10px', color: 'var(--c0f172a)' }}>Link not recognised</h1>
            <p style={{ color: 'var(--c475569)', fontSize: 15, lineHeight: 1.6, margin: 0 }}>
        ...
        <p style={{ color: 'var(--c94a3b8)', fontSize: 12, margin: '24px 0 0' }}>Powered by Lumio Booking</p>
      </div>
    </main>
  );
}
