    ...
    const appointment = await this.prisma.$transaction(async (tx) => {
      ...
      return tx.appointment.create({
        data: {
          ...
          utmTerm: dto.utmTerm?.slice(0, 120) || null,
          gclid: dto.gclid?.slice(0, 300) || null,
          gbraid: dto.gbraid?.slice(0, 300) || null,
          wbraid: dto.wbraid?.slice(0, 300) || null,
          attrLandingUrl: dto.attrLandingUrl?.slice(0, 900) || null,
