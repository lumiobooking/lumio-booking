          ...
          <div key={day} style={{ marginTop: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {list.map((i) => {
                ...
                return (
                  <div key={i.id} style={{ display: 'flex', gap: 12, alignItems: 'flex-start', background: '#1e293b', border: '1px solid #223047', borderRadius: 12, padding: '11px 13px' }}>
                    ...
                    <span style={{ fontSize: 12, color: '#64748b', flexShrink: 0 }}>{rel(i.at)}</span>
                  </div>
                );
              })}
            </div>
