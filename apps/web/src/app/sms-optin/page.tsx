...
export default function SmsOptInPage() {
  ...
  return (
    <main style={wrap}>
      <div style={card}>
        ...
        {done ? (
          <div style={{ textAlign: 'center', padding: '24px 8px' }}>
            ...
            <h2 style={{ fontSize: 18, color: 'var(--c0f172a)', margin: '10px 0 6px' }}>You&rsquo;re signed up!</h2>
            <p style={p}>
          ...
          <form onSubmit={submit}>
            ...
            <label style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginTop: 18, cursor: 'pointer' }}>
              ...
              />
              <span style={{ fontSize: 13.5, color: 'var(--c334155)', lineHeight: 1.55 }}>
      ...
      <div style={{ ...card, marginTop: 18, background: 'var(--cf8fafc)' }}>
        <h2 style={{ fontSize: 15, color: 'var(--c0f172a)', margin: '0 0 8px' }}>How customers opt in</h2>
      ...
      <div style={{ ...card, marginTop: 18 }}>
        <h2 style={{ fontSize: 15, color: 'var(--c0f172a)', margin: '0 0 10px' }}>Sample messages</h2>
        <div style={sample}>
...
const h1: React.CSSProperties = { fontSize: 22, margin: '14px 0 4px', color: 'var(--c0f172a)' };
const muted: React.CSSProperties = { fontSize: 14, color: 'var(--c64748b)', margin: 0 };
const p: React.CSSProperties = { fontSize: 14, lineHeight: 1.6, color: 'var(--c334155)', margin: '0 0 10px' };
const fine: React.CSSProperties = { fontSize: 12.5, lineHeight: 1.55, color: 'var(--c475569)', margin: '0 0 8px' };
